...
class RplPendaftaranController extends Controller
{
    /**
     * Menyimpan data pendaftaran awal untuk pengguna RPL.
     */
    public function submitPendaftaranAwal(Request $request)
    {
        ...
        return response()->json(['message' => 'Data pendaftaran awal RPL berhasil disimpan.']);
    }

    /**
     * Menerima konfirmasi pembayaran formulir dari pengguna RPL.
     */
    public function submitKonfirmasiPembayaran(Request $request)
    {
        ...
        return response()->json(['message' => 'Konfirmasi pembayaran formulir RPL berhasil dikirim.']);
    }

    /**
     * Menerima dan memproses hasil tes seleksi dari pengguna RPL.
     */
    public function submitHasilTes(Request $request)
    {
        try {
            ...
            Log::error('Error saat submit hasil tes RPL: ' . $e->getMessage());
            return response()->json([
                'message' => 'Terjadi kesalahan di server saat memproses hasil tes Anda.',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    /**
     * Menerima konfirmasi pembayaran daftar ulang dari pengguna RPL.
     */
    public function submitKonfirmasiDaful(Request $request)
    {
        ...
        return response()->json(['message' => 'Konfirmasi daftar ulang RPL berhasil dikirim.']);
    }

    /**
     * Menyimpan data diri lengkap (daftar ulang) untuk pengguna RPL.
     */
    public function submitDaftarUlang(Request $request)
    {
        ...
        return response()->json(['message' => 'Data diri lengkap RPL berhasil disimpan.']);
    }
}
